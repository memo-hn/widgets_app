        ...
        child: Column(
          children: [
            Align(
              ...
              child: IconButton(icon: const Icon(Icons.more_vert_outlined), onPressed: () {  },) 
            ),
            Align(
  ...
  Widget build(BuildContext context) {
    ...
    return Card(
      shape: RoundedRectangleBorder(
        borderRadius: const BorderRadiusDirectional.only(bottomStart: Radius.circular(20), topStart: Radius.circular(20)),
